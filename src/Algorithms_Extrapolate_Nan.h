#ifndef Algorithms_Extrapolate_Nan_H
#define Algorithms_Extrapolate_Nan_H
...
class Algorithms_Extrapolate_Nan : public Policy
{
    ...
    public:
    Algorithms_Extrapolate_Nan(Data data, const Policy& pol): Policy(pol),m_grid(data.m_data.GetGridData())
    {
    }
    void Do()
    {
