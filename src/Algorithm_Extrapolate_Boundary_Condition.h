...
private:
    ...
    void SolveMatrix(int s1,int s2,int s3,type_neigh cell)
    {
        ...
        if(s1==1)
        {
            b[0]+=-2*m_1_h.Get(1)*cell.Speed_GetRef().Get(1);
        }
        else
        {
            b[0]+=2*m_1_h.Get(1)*cell.GetNeighbour(1,1).Speed_GetRef().Get(1);
        }
        //term 2
        if(s2==1)
        {
            b[0]+=2*m_1_h.Get(2)*cell.Speed_GetRef().Get(2);
        }
        else
        {
            b[0]+=-2*m_1_h.Get(2)*cell.GetNeighbour(2,1).Speed_GetRef().Get(2);
        }
        //term 3
        if(s3==1)
        {
            b[0]+=0.5*m_1_h.Get(1)*cell.Speed_GetRef().Get(3);
        }
        else
        {
            b[0]+=-0.5*m_1_h.Get(1)*cell.GetNeighbour(3,1).Speed_GetRef().Get(3);
        }
        //term 4-5
        ...
        if(s1==1)
        {
            b[0]+=0.5*m_1_h.Get(3)*cell.Speed_GetRef().Get(1);
        }
        else
        {
            b[0]+=-0.5*m_1_h.Get(3)*cell.GetNeighbour(1,1).Speed_GetRef().Get(1);
        }
        //term 7-8
        b[0]+=s1*0.5*m_1_h.Get(3)*(-cell.GetNeighbour(3,-s3).Speed_GetRef().Get(1)-cell.GetNeighbour(3,-s3).GetNeighbour(1,1).Speed_GetRef().Get(1));

        //term 9
        if(s3==1)
        {
            b[0]+=-0.5*m_1_h.Get(2)*cell.Speed_GetRef().Get(3);
        }
        else
        {
            b[0]+=0.5*m_1_h.Get(2)*cell.GetNeighbour(3,1).Speed_GetRef().Get(3);
        }

        //term 10-11
        b[0]+=s3*0.5*m_1_h.Get(2)*(cell.GetNeighbour(2,-s2).Speed_GetRef().Get(3)+cell.GetNeighbour(2,-s2).GetNeighbour(3,1).Speed_GetRef().Get(3));

        //term 12
        if(s2==1)
        {
            b[0]+=-0.5*m_1_h.Get(3)*cell.Speed_GetRef().Get(2);
        }
        else
        {
            b[0]+=0.5*m_1_h.Get(3)*cell.GetNeighbour(2,1).Speed_GetRef().Get(2);
        }
        //term 13-14
        b[0]+=s2*0.5*m_1_h.Get(3)*(cell.GetNeighbour(3,-s3).Speed_GetRef().Get(2)+cell.GetNeighbour(3,-s3).GetNeighbour(2,1).Speed_GetRef().Get(2));

        b[1]=0;
        //term 1
        if(s3==1)
        {
            b[1]+=-2*m_1_h.Get(3)*cell.Speed_GetRef().Get(3);
        }
        else
        {
            b[1]+=2*m_1_h.Get(3)*cell.GetNeighbour(3,-s3).Speed_GetRef().Get(3);
        }
        //term 2
        if(s2==1)
        {
            b[1]+=2*m_1_h.Get(2)*cell.Speed_GetRef().Get(2);
        }
        else
        {
            b[1]+=-2*m_1_h.Get(2)*cell.GetNeighbour(2,1).Speed_GetRef().Get(2);
        }
        //term 3
        if(s3==1)
        {
            b[1]+=0.5*m_1_h.Get(1)*cell.Speed_GetRef().Get(3);
        }
        else
        {
            b[1]+=-0.5*m_1_h.Get(1)*cell.GetNeighbour(3,1).Speed_GetRef().Get(3);
        }
        //term 4-5
        b[1]+=s3*0.5*m_1_h.Get(1)*(-cell.GetNeighbour(1,-s1).Speed_GetRef().Get(3)-cell.GetNeighbour(1,-s1).GetNeighbour(3,1).Speed_GetRef().Get(3));

        //term 6
        if(s1==1)
        {
            b[1]+=0.5*m_1_h.Get(3)*cell.Speed_GetRef().Get(1);
        }
        else
        {
            b[1]+=-0.5*m_1_h.Get(3)*cell.GetNeighbour(1,1).Speed_GetRef().Get(1);
        }
        //term 7-8
        b[1]+=s1*0.5*m_1_h.Get(3)*(-cell.GetNeighbour(3,-s3).Speed_GetRef().Get(1)-cell.GetNeighbour(3,-s3).GetNeighbour(1,1).Speed_GetRef().Get(1));

        //term 9
        if(s1==1)
        {
            b[1]+=-0.5*m_1_h.Get(2)*cell.Speed_GetRef().Get(1);
        }
        else
        {
            b[1]+=-0.5*m_1_h.Get(2)*cell.GetNeighbour(1,1).Speed_GetRef().Get(1);
        }

        //term 10-11
        b[1]+=s1*0.5*m_1_h.Get(2)*(cell.GetNeighbour(2,-s2).Speed_GetRef().Get(1)+cell.GetNeighbour(2,-s2).GetNeighbour(1,1).Speed_GetRef().Get(1));

        //term 12
        if(s2==1)
        {
            b[1]+=-0.5*m_1_h.Get(1)*cell.Speed_GetRef().Get(2);
        }
        else
        {
            b[1]+=0.5*m_1_h.Get(1)*cell.GetNeighbour(2,1).Speed_GetRef().Get(2);
        }
        //term 13-14
        b[1]+=s2*0.5*m_1_h.Get(1)*(cell.GetNeighbour(1,-s1).Speed_GetRef().Get(2)+cell.GetNeighbour(1,-s1).GetNeighbour(2,1).Speed_GetRef().Get(2));

        b[2]=0;
        if(s1==1)
        {
            b[2]+=m_1_h.Get(1)*cell.Speed_GetRef().Get(1);
        }
        else
        {
            b[2]+=-m_1_h.Get(1)*cell.GetNeighbour(1,1).Speed_GetRef().Get(1);
        }

        if(s2==1)
        {
            b[2]+=m_1_h.Get(2)*cell.Speed_GetRef().Get(2);
        }
        else
        {
            b[2]+=-m_1_h.Get(2)*cell.GetNeighbour(2,1).Speed_GetRef().Get(2);
        }

        if(s3==1)
        {
            b[2]+=m_1_h.Get(3)*cell.Speed_GetRef().Get(3);
        }
        else
        {
            b[2]+=-m_1_h.Get(3)*cell.GetNeighbour(3,1).Speed_GetRef().Get(3);
        }
        int id=SignToInt(s1,s2,s3);
