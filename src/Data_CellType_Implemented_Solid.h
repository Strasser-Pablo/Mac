#ifndef Data_CellType_Implemented_Solid_H
#define Data_CellType_Implemented_Solid_H
 ...
 **/
enum class Data_CellType_Implemented_Solid_Material_Type_Solid{Solid,NoSolid};
...
struct Data_CellType_Implemented_Solid_Traits
{
};
 ...
 **/
template <typename Implementation>
class Data_CellType_Implemented_Solid
{
	public:
	/**
	 * @brief
	 ...
	 **/
	typedef Data_CellType_Implemented_Solid_Material_Type_Solid Material_Type_Solid;
	/**
	 * @brief
	 * Material Type found from the Trait class.
	 **/
	typedef typename Data_CellType_Implemented_Solid_Traits<Implementation>::Material_Type Material_Type;
	bool GetIsSolid(Material_Type mat) const
	{
		return static_cast<const Implementation&> (*this).Material_To_Type_Solid(mat)==Material_Type_Solid::Solid;
	}
};
...
class Data_CellType_Implemented_Solid__InCell :  public Data_CellType_Derivate_SFINAE<Base>
{
	public:
	template<typename T,typename Data_CellType_Constructor_Derivate_SFINAE<T,Base>::type =0>
	Data_CellType_Implemented_Solid__InCell(const T& base):Data_CellType_Derivate_SFINAE<Base>(base)
	{
	}
	template<typename T,typename Data_CellType_Constructor_Not_Derivate_SFINAE<T,Base>::type =0>
	Data_CellType_Implemented_Solid__InCell(const T& base __attribute__ ((unused)))
	{
	}
	bool GetIsSolid() const
	{
		return static_cast<const Implementation&>(*this).m_data_cell_type.GetIsSolid(static_cast<const Implementation&>(*this).m_mat);
	}
};
#endif
