...
class GetCellType_Pressure_Boundary_Domaine : public GetCellType_Pressure_Boundary_Base<TypeWorld,Base,GetCellType_Pressure_Boundary_Domaine<TypeWorld,Base> >
{
	...
	bool GetIsPressure_Boundary_Implementation(const type_key& key1,const type_key& key2,const type_mac_cell& mac1,const type_mac_cell& mac2,bool b1,bool b2,const type_cell & c1,const type_cell & c2,bool b,int sign,int dim);
};
