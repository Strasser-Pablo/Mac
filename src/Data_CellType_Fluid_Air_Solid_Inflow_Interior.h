#ifndef Data_CellType_Fluid_Air_Solid_Inflow_Interior_H
#define Data_CellType_Fluid_Air_Solid_Inflow_Interior_H
...
class Data_CellType_Fluid_Air_Solid_Inflow_Interior;
 ...
 **/
template<typename DataBase>
struct Data_CellType_Implemented_Inflow_Traits<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >
{
	enum class Material_Type{Fluid,Air,Solid,Inflow,Interior};
};


template<typename DataBase>
struct Data_CellType_Implemented_Solid_Traits<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >
{
	typedef typename Data_CellType_Implemented_Inflow_Traits<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >::Material_Type Material_Type;
};

template<typename DataBase>
struct Data_CellType_Implemented_Interior_Traits<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >
{
	typedef typename Data_CellType_Implemented_Inflow_Traits<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >::Material_Type Material_Type;
};

template<typename DataBase>
struct Data_CellType_Implemented_Fluid_Air_Traits<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >
{
	typedef typename Data_CellType_Implemented_Inflow_Traits<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >::Material_Type Material_Type;
};

template <typename DataBase>
class Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell;
 ...
 **/
template <typename DataBase>
class Data_CellType_Fluid_Air_Solid_Inflow_Interior : public Data_CellType_Implemented_Fluid_Air<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >,public Data_CellType_Implemented_Inflow<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >,public Data_CellType_Implemented_Solid<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >,public Data_CellType_Implemented_Interior<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >, public DataBase
{
	public:
		/**
		 * @brief
		 ...
		 **/
		typedef typename Data_CellType_Implemented_Fluid_Air<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >::Material_Type Material_Type;
		/**
		 * @brief
		 * Type used for the Material Fluid Type.
		 * It consist of an enum with two value( Fluid and Air).
		 **/
		typedef typename Data_CellType_Implemented_Fluid_Air<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >::Material_Type_Fluid Material_Type_Fluid;
		typedef typename Data_CellType_Implemented_Inflow<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >::Material_Type_Inflow Material_Type_Inflow;
		typedef typename Data_CellType_Implemented_Solid<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >::Material_Type_Solid Material_Type_Solid;
		typedef typename Data_CellType_Implemented_Interior<Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> >::Material_Type_Interior Material_Type_Interior;
		/**
		 * @brief
		 * Type of the related class used to store in cell.
		 **/
		typedef Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase> type_In_Cell;
		/**
		 * @brief
		 ...
		 **/
		const static int Material_Max_Int=4;
		/**
		 * @brief
		 ...
		 **/
		Data_CellType_Fluid_Air_Solid_Inflow_Interior(Inversible_Value<type_data_value>& rho_fluid,Inversible_Value<type_data_value>& rho_air):m_rho_fluid(rho_fluid),m_rho_air(rho_air)
		{
		}
		/**
		 * @brief
		 ...
		 **/
		Data_CellType_Fluid_Air_Solid_Inflow_Interior()
		{
		}
		/**
		 * @brief
		 ...
		 **/
		Data_CellType_Fluid_Air_Solid_Inflow_Interior(Inversible_Value<type_data_value>& rho_fluid,Inversible_Value<type_data_value>& rho_air,const DataBase& base):m_rho_fluid(rho_fluid),m_rho_air(rho_air),DataBase(base)
		{
		}
		/**
		 * @brief
		 ...
		 * @param base DataBase instance that will be copied.
		 **/
		Data_CellType_Fluid_Air_Solid_Inflow_Interior(const DataBase& base):DataBase(base)
		{
		}
		/**
		 * @brief
		 ...
		 **/
		typedef Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase> type_Cell_type__InCell;
		/**
		 * @brief
...
template<typename DataBase>
struct Data_CellType_Implemented_Fluid_Air_Traits<Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase> >
{
 ...
 **/
template <typename DataBase>
class Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell : public Data_CellType_Implemented_Fluid_Air__InCell<Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase>,DataBase >, public Data_CellType_Implemented_Solid__InCell<Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase>,DataBase >, public Data_CellType_Implemented_Inflow__InCell<Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase>,DataBase >, public Data_CellType_Implemented_Interior__InCell<Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase>,DataBase >
{
	public:
		/**
		 * @brief
		 ...
		 * It consist of an enum with two value( Fluid and Air).
		 **/
		typedef typename Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase>::Material_Type Material_Type;
		/**
		 * @brief
		 * Type used for density return value.
		 * This class has a method Get and GetInv to get the inverse.
		 ...
		 * Material Fluid Type.
		 **/
		typedef typename Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase>::Material_Type_Fluid Material_Type_Fluid;
		typedef typename Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase>::Material_Type_Inflow Material_Type_Inflow;
		typedef typename Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase>::Material_Type_Interior Material_Type_Interior;
		/**
		 * @brief
		 ...
		 **/
		Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell(const Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> & data):Data_CellType_Implemented_Fluid_Air__InCell<Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase>,DataBase >(static_cast<const DataBase&>(data)),Data_CellType_Implemented_Solid__InCell<Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase>,DataBase >(static_cast<const DataBase&>(data)),Data_CellType_Implemented_Inflow__InCell<Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase>,DataBase >(static_cast<const DataBase&>(data)),Data_CellType_Implemented_Interior__InCell<Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell<DataBase>,DataBase >(static_cast<const DataBase&>(data)),m_mat(Material_Type::Air),m_data_cell_type(data),m_no_delete(false)
		{
		}
		/**
		 * @brief
		 ...
		 **/
		Data_CellType_Fluid_Air_Solid_Inflow_Interior__InCell(const Data_CellType_Fluid_Air_Solid_Inflow_Interior<DataBase> & data,Material_Type mat):m_mat(mat),m_data_cell_type(data),m_no_delete(false)
		{
		}
		/**
		 * @brief
...
#include "Data_CellType_Fluid_Air_Solid_Inflow_Interior.tpp"
#endif
