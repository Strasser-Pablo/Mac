JetDEau::JetDEau():m_fluid(1),m_air(0),m_cfl_factor(0.25),m_GetCellType(m_fluid,m_boundary_fluid,m_air,m_boundary_air,m_rho_fluid,m_rho_air,m_1_rho_fluid,m_1_rho_air),
...
m_rho_fluid(1000),m_rho_air(1),m_1_rho_fluid(0.001),m_1_rho_air(1)
{
	#if Use_GooglePerf
