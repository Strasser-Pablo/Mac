#ifndef OutputXMLVTK_With_Line_H
#define OutputXMLVTK_With_Line_H
...
class OutputXMLVTK_With_Line : public OutputXMLVTK_Speed_Pressure<TypeWorld,TypeGetStagSpeedPos,TypeGetSpeed>
{
...
public:
	 ...
	 **/
	OutputXMLVTK_With_Line(TypeWorld &world,TypeGetStagSpeedPos & stag,const Physvector<type_dim,type_data>& h,type_cell fluid,TypeGetSpeed &GetSpeed);
	/**
	 * @brief
	 * Output Particle.
...
;
#include "OutputXMLVTK_With_Line.tpp"
#endif
