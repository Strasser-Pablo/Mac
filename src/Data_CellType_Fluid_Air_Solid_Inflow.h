#ifndef Data_CellType_Fluid_Air_Solid_Inflow_H
#define Data_CellType_Fluid_Air_Solid_Inflow_H
 ...
 **/
template<typename DataBase>
struct Data_CellType_Implemented_Inflow_Traits<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >
{
	enum class Material_Type{Fluid,Air,Solid,Inflow};
};


template<typename DataBase>
struct Data_CellType_Implemented_Solid_Traits<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >
{
	typedef typename Data_CellType_Implemented_Inflow_Traits<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >::Material_Type Material_Type;
};


template<typename DataBase>
struct Data_CellType_Implemented_Fluid_Air_Traits<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >
{
	typedef typename Data_CellType_Implemented_Inflow_Traits<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >::Material_Type Material_Type;
};

template <typename DataBase>
class Data_CellType_Fluid_Air_Solid_Inflow__InCell;
 ...
 **/
template <typename DataBase>
class Data_CellType_Fluid_Air_Solid_Inflow : public Data_CellType_Implemented_Fluid_Air<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >,public Data_CellType_Implemented_Inflow<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >,public Data_CellType_Implemented_Solid<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >, public DataBase
{
	public:
		/**
		 * @brief
		 ...
		 **/
		typedef typename Data_CellType_Implemented_Fluid_Air<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >::Material_Type Material_Type;
		/**
		 * @brief
		 * Type used for the Material Fluid Type.
		 * It consist of an enum with two value( Fluid and Air).
		 **/
		typedef typename Data_CellType_Implemented_Fluid_Air<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >::Material_Type_Fluid Material_Type_Fluid;
		typedef typename Data_CellType_Implemented_Inflow<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >::Material_Type_Inflow Material_Type_Inflow;
		typedef typename Data_CellType_Implemented_Solid<Data_CellType_Fluid_Air_Solid_Inflow<DataBase> >::Material_Type_Solid Material_Type_Solid;
		/**
		 * @brief
		 * Type of the related class used to store in cell.
		 **/
		typedef Data_CellType_Fluid_Air_Solid_Inflow__InCell<DataBase> type_In_Cell;
		/**
		 * @brief
		 ...
		 **/
		const static int Material_Max_Int=3;
		/**
		 * @brief
		 ...
		 **/
		Data_CellType_Fluid_Air_Solid_Inflow(Inversible_Value<type_data_value>& rho_fluid,Inversible_Value<type_data_value>& rho_air):m_rho_fluid(rho_fluid),m_rho_air(rho_air)
		{
		}
		/**
		 * @brief
		 ...
		 **/
		Data_CellType_Fluid_Air_Solid_Inflow(Inversible_Value<type_data_value>& rho_fluid,Inversible_Value<type_data_value>& rho_air,const DataBase& base):m_rho_fluid(rho_fluid),m_rho_air(rho_air),DataBase(base)
		{
		}
		/**
		 * @brief
		 ...
		 * @param base DataBase instance that will be copied.
		 **/
		Data_CellType_Fluid_Air_Solid_Inflow(const DataBase& base):DataBase(base)
		{
		}
		/**
		 * @brief
		 ...
		 **/
		typedef Data_CellType_Fluid_Air_Solid_Inflow__InCell<DataBase> type_Cell_type__InCell;
		/**
		 * @brief
...
template<typename DataBase>
struct Data_CellType_Implemented_Fluid_Air_Traits<Data_CellType_Fluid_Air_Solid_Inflow__InCell<DataBase> >
{
 ...
 **/
template <typename DataBase>
class Data_CellType_Fluid_Air_Solid_Inflow__InCell : public Data_CellType_Implemented_Fluid_Air__InCell<Data_CellType_Fluid_Air_Solid_Inflow__InCell<DataBase>,DataBase >, public Data_CellType_Implemented_Solid__InCell<Data_CellType_Fluid_Air_Solid_Inflow__InCell<DataBase>,DataBase >, public Data_CellType_Implemented_Inflow__InCell<Data_CellType_Fluid_Air_Solid_Inflow__InCell<DataBase>,DataBase >
{
	public:
		/**
		 * @brief
		 ...
		 * It consist of an enum with two value( Fluid and Air).
		 **/
		typedef typename Data_CellType_Fluid_Air_Solid_Inflow<DataBase>::Material_Type Material_Type;
		/**
		 * @brief
		 * Type used for density return value.
		 * This class has a method Get and GetInv to get the inverse.
		 ...
		 * Material Fluid Type.
		 **/
		typedef typename Data_CellType_Fluid_Air_Solid_Inflow<DataBase>::Material_Type_Fluid Material_Type_Fluid;
		typedef typename Data_CellType_Fluid_Air_Solid_Inflow<DataBase>::Material_Type_Inflow Material_Type_Inflow;
		/**
		 * @brief
...
#include "Data_CellType_Fluid_Air_Solid_Inflow.tpp"
#endif
