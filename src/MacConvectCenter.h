#ifndef MACCONVECTCENTER_H
#define MACCONVECTCENTER_H
...
class MacConvectCenter
{
	 ...
	 **/
	MacConvectCenter(TypeWorld & world,TypeGetSpeed & GetSpeed, TypeGetStagSpeedPos &GetStagPos,type_data & dt,GetTypeCell& getTypeCell,Physvector<type_dim,type_data>& h,Physvector<type_dim,type_data>& _1_h);
	/**
	 * @brief
