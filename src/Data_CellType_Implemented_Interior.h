#ifndef Data_CellType_Implemented_Interior_H
#define Data_CellType_Implemented_Interior_H
 ...
 **/
enum class Data_CellType_Implemented_Interior_Material_Type_Interior{Interior,NoInterior};
...
struct Data_CellType_Implemented_Interior_Traits
{
};
 ...
 **/
template <typename Implementation>
class Data_CellType_Implemented_Interior
{
	public:
	/**
	 * @brief
	 ...
	 **/
	typedef Data_CellType_Implemented_Interior_Material_Type_Interior Material_Type_Interior;
	/**
	 * @brief
	 * Material Type found from the Trait class.
	 **/
	typedef typename Data_CellType_Implemented_Interior_Traits<Implementation>::Material_Type Material_Type;
	bool GetIsInterior(Material_Type mat) const
	{
		return static_cast<const Implementation&> (*this).Material_To_Type_Interior(mat)==Material_Type_Interior::Interior;
	}
};
...
class Data_CellType_Implemented_Interior__InCell :  public Data_CellType_Derivate_SFINAE<Base>
{
	public:
	template<typename T,typename Data_CellType_Constructor_Derivate_SFINAE<T,Base>::type =0>
	Data_CellType_Implemented_Interior__InCell(const T& base):Data_CellType_Derivate_SFINAE<Base>(base)
	{
	}
	template<typename T,typename Data_CellType_Constructor_Not_Derivate_SFINAE<T,Base>::type =0>
	Data_CellType_Implemented_Interior__InCell(const T& base __attribute__ ((unused)))
	{
	}
	bool GetIsInterior() const
	{
		return static_cast<const Implementation&>(*this).m_data_cell_type.GetIsInterior(static_cast<const Implementation&>(*this).m_mat);
	}
};
#endif
