...
class Test_Extrapolate2 : public CxxTest::TestSuite
{
	...
	void test1d()
	{
		...
		vect v_h;
		v_h.SetAll(1);
		ExtrapolateCellFluid2<world,type_getcelltype>  Ex(W,m_GetCellType,v_h,v_h);
		Ex.Calculate();
		vkey.Set(1,0);
		int lay;
		...
		void test2dvar3()
	{
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,0);
		TS_ASSERT_DELTA(tempspeed.Get(1),1,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),2,0.001);
		vkey.Set(1,1);
		W.m_mac_grid[vkey].GetLayer(lay);
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,0);
		TS_ASSERT_DELTA(tempspeed.Get(1),2,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),2,0.001);
		vkey.Set(1,-1);
		W.m_mac_grid[vkey].GetLayer(lay);
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		...
		TS_ASSERT_EQUALS(lay,1);
		TS_ASSERT_DELTA(tempspeed.Get(1),2,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1,0.001);
		vkey.Set(2,-1);
		W.m_mac_grid[vkey].GetLayer(lay);
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,1);
		...
		TS_ASSERT_EQUALS(lay,2);
		TS_ASSERT_DELTA(tempspeed.Get(1),2,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.66666,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,1);
		TS_ASSERT_DELTA(tempspeed.Get(1),3,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),2,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,3);
		TS_ASSERT_DELTA(tempspeed.Get(1),2.0,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.25,0.001);
		...
		TS_ASSERT_EQUALS(lay,4);
		TS_ASSERT_DELTA(tempspeed.Get(1),2,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.8055,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,2);
		TS_ASSERT_DELTA(tempspeed.Get(1),0.8055,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.8055,0.001);
		...
		TS_ASSERT_EQUALS(lay,3);
		TS_ASSERT_DELTA(tempspeed.Get(1),2,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.7777,0.001);
		...
		TS_ASSERT_EQUALS(lay,4);
		TS_ASSERT_DELTA(tempspeed.Get(1),2,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.77777,0.001);
		...
		void test2dvar4()
	{
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,1);
		TS_ASSERT_DELTA(tempspeed.Get(1),-1.33333,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.6666,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,1);
		TS_ASSERT_DELTA(tempspeed.Get(1),-1.1666,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.25,0.001);
		vkey.Set(2,-1);
		W.m_mac_grid[vkey].GetLayer(lay);
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,1);
		TS_ASSERT_DELTA(tempspeed.Get(1),-1.16666,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.83333,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,2);
		TS_ASSERT_DELTA(tempspeed.Get(1),-1.0833,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.5833,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,4);
		TS_ASSERT_DELTA(tempspeed.Get(1),-1.1388,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.6666,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,2);
		TS_ASSERT_DELTA(tempspeed.Get(1),-0.666,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.666,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,3);
		TS_ASSERT_DELTA(tempspeed.Get(1),-0.875,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.625,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,4);
		TS_ASSERT_DELTA(tempspeed.Get(1),-1.2013,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.7013,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,2);
		TS_ASSERT_DELTA(tempspeed.Get(1),-1.3472,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.6527,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,3);
		TS_ASSERT_DELTA(tempspeed.Get(1),-1.1250,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.3750,0.001);
		...
		W.m_mac_grid[vkey].GetSpeed(tempspeed);
		TS_ASSERT_EQUALS(lay,3);
		TS_ASSERT_DELTA(tempspeed.Get(1),-1.1527,0.001);
		TS_ASSERT_DELTA(tempspeed.Get(2),1.75,0.001);
