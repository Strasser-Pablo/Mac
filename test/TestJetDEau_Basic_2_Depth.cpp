...
int main()
{
	...
	typedef Data_Chunk<type_bool_array,type_chunk_layer,type_chunk_depth,type_chunk_celltype,type_chunk_speed,type_chunk_pressure> type_chunk;
	type_chunk m_chunk(m_bool_array,m_chunk_layer,m_chunk_depth,m_chunk_celltype,m_chunk_speed,m_chunk_pressure);
	...
	typedef Offset_Base_CellType<type_cell_grid_celltype,type_off_base_depth> type_off_base_celltype;
