...
#include "../src/Data_CellType_Fluid_Air_Solid_Inflow_0_Pres.h"
#include "../src/Data_Base_Dim_Type.h"
#define eps 1e-10
class Test_Data_CellType_Fluid_Air_Solid_Inflow_0_Pres : public CxxTest::TestSuite  //LCOV_EXCL_LINE 
{
	public:
	/**
	...
	void test_Base()
	{
		...
		typedef Data_CellType_Fluid_Air_Solid_Inflow_0_Pres<DataBase>::Material_Type Material_Type;
		typedef Data_CellType_Fluid_Air_Solid_Inflow_0_Pres<DataBase>::Material_Type_Fluid Material_Type_Fluid;
		Data_CellType_Fluid_Air_Solid_Inflow_0_Pres<DataBase> D;
	...
	void test_GetRho()
	{
		...
		Data_CellType_Fluid_Air_Solid_Inflow_0_Pres<DataBase> D2(rho_fluid,rho_air);
		TS_ASSERT_DELTA(D.GetRhoAir().Get(),1,eps);
		TS_ASSERT_DELTA(D.GetRhoAir().Get_Inv(),1,eps);
		TS_ASSERT_DELTA(D.GetRhoFluid().Get(),1000,eps);
		TS_ASSERT_DELTA(D.GetRhoFluid().Get_Inv(),1./1000,eps);
