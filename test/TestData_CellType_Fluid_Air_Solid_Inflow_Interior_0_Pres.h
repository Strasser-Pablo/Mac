...
class Test_Data_CellType_Fluid_Air_Solid_Inflow : public CxxTest::TestSuite  //LCOV_EXCL_LINE 
{
	...
	void test_Base()
	{
		...
		typedef Data_CellType_Fluid_Air_Solid_Inflow_Interior_0_Pres<DataBase>::Material_Type Material_Type;
		typedef Data_CellType_Fluid_Air_Solid_Inflow_Interior_0_Pres<DataBase>::Material_Type_Fluid Material_Type_Fluid;
		Data_CellType_Fluid_Air_Solid_Inflow_Interior_0_Pres<DataBase> D;
	...
	void test_Fluid()
	{
		...
		TS_ASSERT(D.GetIsFluid(Material_Type::Interior));
		TS_ASSERT(D.GetIsFluid(Material_Type::_0_Pres));
	}
	/**
	...
	void test_Air()
	{
		...
		TS_ASSERT(!D.GetIsAir(Material_Type::Interior));
		TS_ASSERT(!D.GetIsAir(Material_Type::_0_Pres));
	}
	...
	void test_GetRho()
	{
		...
		Data_CellType_Fluid_Air_Solid_Inflow_Interior_0_Pres<DataBase> D2(rho_fluid,rho_air);
		TS_ASSERT_DELTA(D.GetRhoAir().Get(),1,eps);
		TS_ASSERT_DELTA(D.GetRhoAir().Get_Inv(),1,eps);
		TS_ASSERT_DELTA(D.GetRhoFluid().Get(),1000,eps);
		TS_ASSERT_DELTA(D.GetRhoFluid().Get_Inv(),1./1000,eps);
	...
	void test_Solid()
	{
		...
		TS_ASSERT(!D.GetIsSolid(Material_Type::Interior));
		TS_ASSERT(!D.GetIsSolid(Material_Type::_0_Pres));
	}
	...
	void test_Inflow()
	{
		...
		TS_ASSERT(!D.GetIsInflow(Material_Type::Interior));
		TS_ASSERT(!D.GetIsInflow(Material_Type::_0_Pres));
	}
	void test_Interior()
	{
		typedef Data_Base_Dim_Type<double,3> DataBase;
		...
		typedef Data_CellType_Fluid_Air_Solid_Inflow_Interior_0_Pres<DataBase>::Material_Type_Fluid Material_Type_Fluid;
		Data_CellType_Fluid_Air_Solid_Inflow_Interior_0_Pres<DataBase> D;
		TS_ASSERT(!D.GetIsInterior(Material_Type::Fluid));
		TS_ASSERT(!D.GetIsInterior(Material_Type::Air));
		TS_ASSERT(!D.GetIsInterior(Material_Type::Inflow));
		TS_ASSERT(!D.GetIsInterior(Material_Type::Solid));
		TS_ASSERT(D.GetIsInterior(Material_Type::Interior));
		TS_ASSERT(!D.GetIsInterior(Material_Type::_0_Pres));
	}
	void test_0_Pres()
	{
		typedef Data_Base_Dim_Type<double,3> DataBase;
		...
		typedef Data_CellType_Fluid_Air_Solid_Inflow_Interior_0_Pres<DataBase>::Material_Type_Fluid Material_Type_Fluid;
		Data_CellType_Fluid_Air_Solid_Inflow_Interior_0_Pres<DataBase> D;
		TS_ASSERT(!D.GetIs0_Pres(Material_Type::Fluid));
		TS_ASSERT(!D.GetIs0_Pres(Material_Type::Air));
		TS_ASSERT(!D.GetIs0_Pres(Material_Type::Inflow));
		TS_ASSERT(!D.GetIs0_Pres(Material_Type::Solid));
		TS_ASSERT(!D.GetIs0_Pres(Material_Type::Interior));
		TS_ASSERT(D.GetIs0_Pres(Material_Type::_0_Pres));
	}
};
