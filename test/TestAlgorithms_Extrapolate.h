...
class TestAlgorithms_Extrapolate : public CxxTest::TestSuite  //LCOV_EXCL_LINE 
{
	...
	void test1d1()
	{
		...
		v.Set(1,2);
		m_data_ref.m_data.GetGridData()[v].GetRef().SetLayer(2);
		m_data_ref.m_data.GetGridData()[v].GetRef().Speed_Set(Data_Speed_Data<1,double>(speed));
		...
		v.Set(1,-3);
		m_data_ref.m_data.GetGridData()[v].GetRef().SetLayer(3);
		m_data_ref.m_data.GetGridData()[v].GetRef().Speed_Set(Data_Speed_Data<1,double>(speed));

		v.Set(1,-4);
		m_data_ref.m_data.GetGridData()[v].GetRef().SetLayer(4);
		m_data_ref.m_data.GetGridData()[v].GetRef().Speed_Set(Data_Speed_Data<1,double>(speed));
		...
		v.Set(1,0);
		TS_ASSERT_DELTA(m_data_ref.m_data.GetGridData()[v].GetRef().Speed_Get(1),1,eps);
	...
	void test2d1()
	{
		...
		v.Set(2,0);
		TS_ASSERT_DELTA(m_data_ref.m_data.GetGridData()[v].GetRef().Speed_Get(1),1,eps);
		TS_ASSERT_DELTA(m_data_ref.m_data.GetGridData()[v].GetRef().Speed_Get(2),1,eps);
