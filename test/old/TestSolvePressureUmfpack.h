...
class Test_SolvePressureUmfpack : public CxxTest::TestSuite
{
	...
	void test1dInternConstSpeed()
	{
		...
		W.m_mac_grid[vkey].GetPressure(ptemp);
		TS_ASSERT_DELTA(ptemp,2000.0,eps);
	}
	
	void test2dInternConstSpeed()
	{	
		typedef Physvector<2,int> keyvect;
		typedef Physvector<2,double> vect;
		typedef Particle<vect> part;
		...
		vkey.Set(2,0);
		W.m_mac_grid[vkey].GetPressure(ptemp);
		TS_ASSERT_DELTA(ptemp,727.2727,0.001);
		
		vkey.Set(2,-1);
		W.m_mac_grid[vkey].GetPressure(ptemp);
		TS_ASSERT_DELTA(ptemp,-666.666,0.001);
		
		vkey.Set(2,1);
		W.m_mac_grid[vkey].GetPressure(ptemp);
		TS_ASSERT_DELTA(ptemp,181.8181,0.001);
	}
	
	void test2dInternConstSpeed2()
	{	
		typedef Physvector<2,int> keyvect;
		typedef Physvector<2,double> vect;
		typedef Particle<vect> part;
		...
		vkey.Set(2,0);
		W.m_mac_grid[vkey].GetPressure(ptemp);
		TS_ASSERT_DELTA(ptemp,786.2407,0.001);
		
		vkey.Set(2,-1);
		W.m_mac_grid[vkey].GetPressure(ptemp);
		TS_ASSERT_DELTA(ptemp,-712.5307,0.001);
		
		vkey.Set(2,1);
		W.m_mac_grid[vkey].GetPressure(ptemp);
		TS_ASSERT_DELTA(ptemp,196.5601,0.001);
	}

	void test2dInternConstSpeed3()
	{	
		typedef Physvector<2,int> keyvect;
		typedef Physvector<2,double> vect;
		typedef Particle<vect> part;
		...
		vkey.Set(2,-1);
		W.m_mac_grid[vkey].GetPressure(ptemp);
		TS_ASSERT_DELTA(ptemp,500.00,0.001);
