...
#include "../src/ComputeSpeedLaplacien.h"
#define eps 1e-10
class Test_ComputeSpeedLaplacien : public CxxTest::TestSuite
{
	public:
	void test1dconst()
	{
		...
		vh.Set(1,1.0);
		ComputeSpeedLaplacien<world> lap(W,vh);
		vkey.Set(1,0);
		Physvector<1,double> res;
		lap.Calculate(vkey,res);
		TS_ASSERT_DELTA(res.Get(1),0.0,eps);
	}
		...
		void test1d()
	{
		...
		Physvector<1,double> res;
		lap.Calculate(vkey,res);
		TS_ASSERT_DELTA(res.Get(1),-4.0,eps);
	}
		...
		void test2d()
	{
		...
		Physvector<2,double> res;
		lap.Calculate(vkey,res);
		TS_ASSERT_DELTA(res.Get(1),-8.0,eps);
		TS_ASSERT_DELTA(res.Get(2),0.0,eps);
	}
};