...
#define eps 1e-10
class TestAlgorithms_Speed_Interpolation : public CxxTest::TestSuite  //LCOV_EXCL_LINE 
{
	public:
	void test_Layer_Initial1d1()
	{
		...
		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(1),1,eps);
		...
		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(1),1.5,eps);

		pos.Set(1,0.1);

		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(1),1.4,eps);
	...
	void test_Layer_Initial1d2()
	{
		...
		Policy_Speed_Interpolation_Linear<type_data_ref> m_pol(m_data_ref);
		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(1),1,eps);
		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(2),1,eps);
		...
		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(1),1.5,eps);
		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(2),2,eps);

		pos.Set(1,0.1);
		pos.Set(2,0.1);

		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(1),1.8,eps);
		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(2),2.1,eps);
	}
	...
	void test_Layer_Initial1d1h()
	{
		...
		Policy_Speed_Interpolation_Linear<type_data_ref> m_pol(m_data_ref);
		TS_ASSERT_DELTA(m_pol.Get_Speed(pos).Get(1),1.0,eps);
