...
class Test_Data_Inteface_Domain_Rho_fluid : public CxxTest::TestSuite   //LCOV_EXCL_LINE 
{
	...
	void testInterface()
	{
		...
		DataBase base;
		typedef Data_Staggered_Left<DataBase> type_stag_left;
		type_stag_left m_stag_left(base);
		typedef typename type_stag_left::type_data_value type_data_value;
		typedef Data_CellType_Fluid_Air<type_stag_left> type_cell_type;
		typedef Data_Grid_Speed<type_stag_left> type_grid_speed;
		typedef Data_Grid_Pressure<type_stag_left> type_grid_pressure;
		type_grid_speed m_grid_speed;
		type_grid_pressure m_grid_pressure;
		Data_CellType_Fluid_Air<type_stag_left> D(m_stag_left);
		...
		typedef Datas<type_stag_left,type_domain_fluid,type_grid_speed,type_grid_pressure> type_datas;
		type_datas m_datas(m_stag_left,m_dom_fluid,m_grid_speed,m_grid_pressure);
