...
class Test_Data_Grid_Speed : public CxxTest::TestSuite  //LCOV_EXCL_LINE 
{
	public:
		...
		void test_temp_set_get()
		{
			typedef Data_Base_Dim_Type<double,3> DataBase;
			typedef Data_Grid_Speed<DataBase> type_grid_speed;
			type_grid_speed m_grid_speed;
			m_grid_speed.Speed_Temp_Set(1,3.4);
			m_grid_speed.Speed_Temp_Set(2,4.4);
			m_grid_speed.Speed_Temp_Set(3,9);
			TS_ASSERT_DELTA(m_grid_speed.Speed_Temp_Get(1),3.4,eps);
			TS_ASSERT_DELTA(m_grid_speed.Speed_Temp_Get(2),4.4,eps);
			TS_ASSERT_DELTA(m_grid_speed.Speed_Temp_Get(3),9,eps);
			
			typedef typename type_grid_speed::type_speed type_speed;
			type_speed s=m_grid_speed.Speed_Temp_Get();
			...
			type_grid_speed m_grid_speed2;
			m_grid_speed2.Speed_Temp_Set(s);

			TS_ASSERT_DELTA(m_grid_speed2.Speed_Temp_Get(1),3.4,eps);
			TS_ASSERT_DELTA(m_grid_speed2.Speed_Temp_Get(2),4.4,eps);
			TS_ASSERT_DELTA(m_grid_speed2.Speed_Temp_Get(3),9,eps);
		}
		void test_temp_Grid_Speed_Const()
		{
			typedef Data_Base_Dim_Type<double,3> DataBase;
			typedef Data_Grid_Speed<DataBase> type_grid_speed;
			type_grid_speed m_grid_speed;
			...
			typedef typename type_grid_speed::type_speed type_speed;
			type_speed m_speed=m_grid_speed.Speed_Temp_Get();
			m_grid_speed.Speed_Set_Const(1);
			m_grid_speed.Speed_Temp_Set(1,5);
			TS_ASSERT_DELTA(m_grid_speed.Speed_Temp_Get(1),3.4,eps);
			m_grid_speed.Speed_Set_None_Const(1);
			m_grid_speed.Speed_Temp_Set(1,5);
			TS_ASSERT_DELTA(m_grid_speed.Speed_Temp_Get(1),5,eps);
			m_grid_speed.Speed_Temp_Set(m_speed);
			TS_ASSERT_DELTA(m_grid_speed.Speed_Temp_Get(1),3.4,eps);

			m_grid_speed.Speed_Temp_Set(1,33.4);
			m_grid_speed.Speed_Temp_Set(2,44.4);
			m_grid_speed.Speed_Temp_Set(3,33);
			...
			TS_ASSERT_DELTA(m_grid_speed.Speed_Temp_Get(1),33.4,eps);
			TS_ASSERT_DELTA(m_grid_speed.Speed_Temp_Get(2),44.4,eps);
			TS_ASSERT_DELTA(m_grid_speed.Speed_Temp_Get(3),9,eps);
	...
	void test_temp_invert()
	{
		...
		m_grid_speed.Speed_Speed_To_Temp();
		...
		type_grid_speed m_grid_speed2;
		m_grid_speed2.Speed_Temp_Set(1,3.4);
		m_grid_speed2.Speed_Temp_Set(2,4.4);
		m_grid_speed2.Speed_Temp_Set(3,9);
		
		m_grid_speed2.Speed_Temp_To_Speed();
