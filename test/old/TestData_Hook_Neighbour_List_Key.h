...
class Test_Data_Neighbour_List_Key : public CxxTest::TestSuite   //LCOV_EXCL_LINE
{
    public:
    void testHook1()
    {
        ...
        ChunkHashTable<Hook_Neighbour_List_Key,vect,Neighbour_List<3,int>,true,Hash> table(Neighbour_List<3,int>(3),hash);
        vect v;
        v.Set(1,0);
        v.Set(2,0);
        v.Set(3,0);
    ...
    void testHook2()
    {
        ...
        Hookable_Hash_Table<Hook_Neighbour_List_Key,vect,Neighbour_List<3,int>,false,Hash> table(hash);
        vect v;
        v.Set(1,0);
        v.Set(2,0);
        v.Set(3,0);
    ...
    void testHook3()
    {
        ...
        typedef HashPhysvector<3,int> Hash;
        Hash hash;
        typedef Hookable_Hash_Table<Hook_Neighbour_List_Key,vect,Neighbour_List<3,int>,true,Hash> type_table;
