...
class Test_Data_Neighbour_List : public CxxTest::TestSuite   //LCOV_EXCL_LINE 
{
	...
	void testInt1d()
	{
		...
		N.SetNeighbour(1,1,&(N2.GetRef()));
		N.SetNeighbour(1,-1,&(N3.GetRef()));
		TS_ASSERT_EQUALS(N.Get(),1);
		TS_ASSERT_EQUALS(*(N.GetNeighbour(1,1)),2);
		TS_ASSERT_EQUALS(*(N.GetNeighbour(1,-1)),3);
	}
	...
	void testInt2d()
	{
		...
		N.SetNeighbour(1,1,&(N2.GetRef()));
		N.SetNeighbour(2,-1,&(N3.GetRef()));
		N.SetNeighbour(2,1,&(N4.GetRef()));
		N.SetNeighbour(1,-1,&(N5.GetRef()));
		TS_ASSERT_EQUALS(N.Get(),1);
		TS_ASSERT_EQUALS(*(N.GetNeighbour(1,1)),2);
		TS_ASSERT_EQUALS(*(N.GetNeighbour(2,-1)),3);
		TS_ASSERT_EQUALS(*(N.GetNeighbour(2,1)),4);
		TS_ASSERT_EQUALS(*(N.GetNeighbour(1,-1)),5);
	}
	...
	void testSpeed2d()
	{
		...
		TS_ASSERT_EQUALS((N.GetNeighbour(1,1))->m_speed[0],3);
		TS_ASSERT_EQUALS((N.GetNeighbour(1,1))->m_speed[1],4);
		TS_ASSERT_EQUALS((N.GetNeighbour(1,1))->m_speed[2],5);
	}
};
